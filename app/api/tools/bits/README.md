...
-- Covering index for snapshot table with the exact columns needed
CREATE NONCLUSTERED INDEX IX_FCT_DEMAND_BR_SNAPSHOT_PERIOD_END_BR
ON [EDR_CARZ].[FCT_DEMAND_BR_SNAPSHOT] (PERIOD_END_DATE, BR_NMBR)
INCLUDE (STATUS_ID);
```
