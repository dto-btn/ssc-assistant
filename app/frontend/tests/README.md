...
- `e2e/fixtures/mockPlayground.ts`: deterministic browser-level mocks for auth bypass, playground API requests, feedback, uploads, archived sessions, and streamed assistant responses.
