 ...
 *
 * Redux middleware that intercepts assistant-related actions (send message,
 * receive streaming chunks, tool invocations) and performs side-effects such
 * as calling APIs or dispatching additional events.
 */
