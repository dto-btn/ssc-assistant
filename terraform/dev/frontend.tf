...
resource "azurerm_linux_web_app" "frontend" {
  ...
  app_settings = {
    ...
    VITE_ALLOWED_TOOLS            = "corporate, geds, archibus"
  }

  sticky_settings {
    app_setting_names = [ "VITE_API_BACKEND", "VITE_API_KEY", "WEBSITE_RUN_FROM_PACKAGE", "MICROSOFT_PROVIDER_AUTHENTICATION_SECRET", "PORT", "VITE_ALLOWED_TOOLS"]
  }
